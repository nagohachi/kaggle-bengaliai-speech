...
MODEL_PATH = INPUT / "yellowking_models/YellowKing_model"
LM_PATH = INPUT / "yellowking_models/YellowKing_processor/language_model"
...
train = pd.read_csv(DATA / "train_normalized_with_noise_info.csv", dtype={"id": str})
